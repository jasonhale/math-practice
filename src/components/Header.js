    ...
    <header className="mainColumn mainSection">
      ...
      <section id="pageUI" className="mainColumn mainSection">
        <div className="button-list">
          ...
          <label htmlFor="max-count" className="text-small button-list-item inline-input">Total problems: <input name="max-count" className="input input-simple js-max-count" type="number" placeholder="Enter Number of Problems..." value={count} onChange={updateCount}/></label>
